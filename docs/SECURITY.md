...
If you discover a security vulnerability in Chisel, please report it responsibly.
...
Chisel is a CPI helper library — it constructs and dispatches cross-program invocations. Security considerations include:
...
Chisel has not yet undergone a formal security audit. Use in production at your own discretion. We welcome community review and responsible disclosure.
